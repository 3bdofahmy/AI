...
system_prompt = Template("\n".join([
    "You are an assistant to generate a response for the user", #  about interview skills.
...
footer_prompt = Template("\n".join([
    # "Based only on the above documents, please generate an answer for the user. Be precise ",
